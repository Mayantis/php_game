...
Final class RpgGame extends AbstractGame
{
    ...
    public function moveMonsters(){
        ...
        foreach($this->monsters as $oMonster){
            // Mémoriser la case de départ du monstre
            $posInit = $oMonster->getXY();

            // Effacer l'ancienne case du monstre
            $this->aBoard[$posInit['y']][$posInit['x']] = ' ';

            // Obtention des deplacements valides
